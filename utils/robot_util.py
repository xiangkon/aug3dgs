...
class FrankaEmikaPanda(ERobot):
    ...
    def __init__(self):
        ...
        links, name, urdf_string, urdf_filepath = super().URDF_read(
            rtb.rtb_path_to_datafile("/home/admin123/ssd/Projects/RoboSplat/data/asset/robot/panda/panda.urdf"), tld=FrankaEmikaPanda.load_my_path())
        os.chdir(origin_dir)
        super().__init__(
            links,
            name=name,
...
class RobotUtil:
    ...
    def load_robot(self, urdf_path='/home/admin123/ssd/Projects/RoboSplat/data/asset/robot/panda/panda.urdf'):
    ...
    def setup_planner(self, urdf_path='/home/admin123/ssd/Projects/RoboSplat/data/asset/robot/panda/panda.urdf', srdf_path='/home/admin123/ssd/Projects/RoboSplat/data/asset/robot/panda/panda.srdf', move_group='panda_hand_tcp'):
